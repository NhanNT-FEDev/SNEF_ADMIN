                ...
                <c:if test="${info == null}">
                    <form method="POST" action="/admin/insert" enctype="multipart/form-data">
                        <div class="form-group">
                            <label for="stName">Store Name</label>
                            <input type="text" id="stName" class="form-control" placeholder="Enter Store Name"
                                   name="stName" value="">
                            <!-- <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small> -->
                        </div>
                        <div class="form-group">
                            <label for="stLocal">Address</label>
                            <input type="text" class="form-control" id="stLocal" placeholder="Address" name="stLocal"
                                   value="">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="stOpen">Open Hour</label>
                            <input type="text" class="form-control" id="stOpen" placeholder="Open Hour" name="stOpen"
                                   value="">
                        </div>

                        <div class="form-group">
                            <label for="stClose">Close Hour</label>
                            <input type="text" class="form-control" id="stClose" placeholder="Close Hour" name="stClose"
                                   value="">
                        </div>

                        <div class="form-group">
                            <label>Store Status</label> <br/>
                            <input type="checkbox" name="chkStatus" value=""> <span>(Check if Active)</span>
                        </div>
                ...
                <c:if test="${info != null}">
                    <form action="/admin/save" method="POST">
                        <c:forEach var="rs" items="${info}">
                            ...
                            <div class="form-group">
                                <label for="stLocal">Address</label>
                                <input type="text" class="form-control" id="stLocal" placeholder="Address"
                                       name="stLocal"     value="">
                            </div>
                            <div class="form-group">
                                <label for="customFile"> Choose Store Image</label>
